...
void DWrite::Change()
{
    ...
    {
        m_textLayout->SetFlowDirection(DWRITE_FLOW_DIRECTION_TOP_TO_BOTTOM);
        m_textLayout->SetReadingDirection(DWRITE_READING_DIRECTION_LEFT_TO_RIGHT);
    });
    m_actions.push_back([this]()
    {
        m_textLayout->SetFlowDirection(DWRITE_FLOW_DIRECTION_TOP_TO_BOTTOM);
    ...
    m_actions.push_back([this]()
    {
        m_textLayout->SetFlowDirection(DWRITE_FLOW_DIRECTION_LEFT_TO_RIGHT);
        m_textLayout->SetReadingDirection(DWRITE_READING_DIRECTION_TOP_TO_BOTTOM);
    });
    m_actions.push_back([this]()
    {
        m_textLayout->SetFlowDirection(DWRITE_FLOW_DIRECTION_LEFT_TO_RIGHT);
        m_textLayout->SetReadingDirection(DWRITE_READING_DIRECTION_BOTTOM_TO_TOP);
    });
    m_actions.push_back([this]()
    {
        m_textLayout->SetFlowDirection(DWRITE_FLOW_DIRECTION_RIGHT_TO_LEFT);
        m_textLayout->SetReadingDirection(DWRITE_READING_DIRECTION_TOP_TO_BOTTOM);
    });
    m_actions.push_back([this]()
    {
